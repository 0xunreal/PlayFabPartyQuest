...
typedef
PartyError
(PARTY_API* PartyEndpointGetProperty_FUNC)(
    PARTY_ENDPOINT_HANDLE endpoint,
    PartyString key,
...
typedef
PartyError
(PARTY_API* PartyEndpointGetPropertyKeys_FUNC)(
    PARTY_ENDPOINT_HANDLE endpoint,
...
typedef
PartyError
(PARTY_API* PartyEndpointSetProperties_FUNC)(
    PARTY_ENDPOINT_HANDLE endpoint,
...
typedef
PartyError
(PARTY_API* PartyDeviceGetProperty_FUNC)(
    PARTY_DEVICE_HANDLE device,
    PartyString key,
    _Outptr_result_maybenull_ const PARTY_DATA_BUFFER** value
    );
...
typedef
PartyError
(PARTY_API* PartyDeviceGetPropertyKeys_FUNC)(
    PARTY_DEVICE_HANDLE device,
    _Out_ uint32_t* propertyCount,
    _Outptr_result_buffer_(*propertyCount) const PartyString** keys
    );
...
typedef
PartyError
(PARTY_API* PartyDeviceSetProperties_FUNC)(
    PARTY_DEVICE_HANDLE device,
    uint32_t propertyCount,
    _In_reads_(propertyCount) const PartyString* keys,
    _In_reads_(propertyCount) const PARTY_DATA_BUFFER* values
...
typedef
PartyError
(PARTY_API* PartyNetworkGetProperty_FUNC)(
    PARTY_NETWORK_HANDLE network,
    PartyString key,
    _Outptr_result_maybenull_ const PARTY_DATA_BUFFER** value
    );
...
typedef
PartyError
(PARTY_API* PartyNetworkGetPropertyKeys_FUNC)(
    PARTY_NETWORK_HANDLE network,
    _Out_ uint32_t* propertyCount,
    _Outptr_result_buffer_(*propertyCount) const PartyString** keys
    );
...
typedef
PartyError
(PARTY_API* PartyNetworkSetProperties_FUNC)(
    PARTY_NETWORK_HANDLE network,
    uint32_t propertyCount,
    _In_reads_(propertyCount) const PartyString* keys,
    _In_reads_(propertyCount) const PARTY_DATA_BUFFER* values
...
typedef
PartyError
(PARTY_API* PartyChatControlGetProperty_FUNC)(
    PARTY_CHAT_CONTROL_HANDLE chatControl,
    PartyString key,
    _Outptr_result_maybenull_ const PARTY_DATA_BUFFER** value
    );
...
typedef
PartyError
(PARTY_API* PartyChatControlGetPropertyKeys_FUNC)(
    PARTY_CHAT_CONTROL_HANDLE chatControl,
    _Out_ uint32_t* propertyCount,
    _Outptr_result_buffer_(*propertyCount) const PartyString** keys
    );
...
typedef
PartyError
(PARTY_API* PartyChatControlSetProperties_FUNC)(
    PARTY_CHAT_CONTROL_HANDLE chatControl,
    uint32_t propertyCount,
    _In_reads_(propertyCount) const PartyString* keys,
    _In_reads_(propertyCount) const PARTY_DATA_BUFFER* values
...
typedef struct {
    ...
    PartyEndpointGetProperty_FUNC PartyEndpointGetProperty;
    PartyEndpointGetPropertyKeys_FUNC PartyEndpointGetPropertyKeys;
    PartyEndpointSetProperties_FUNC PartyEndpointSetProperties;
    ...
    PartyDeviceGetProperty_FUNC PartyDeviceGetProperty;
    PartyDeviceGetPropertyKeys_FUNC PartyDeviceGetPropertyKeys;
    PartyDeviceSetProperties_FUNC PartyDeviceSetProperties;
    ...
    PartyNetworkGetProperty_FUNC PartyNetworkGetProperty;
    PartyNetworkGetPropertyKeys_FUNC PartyNetworkGetPropertyKeys;
    PartyNetworkSetProperties_FUNC PartyNetworkSetProperties;
    ...
    PartyChatControlGetProperty_FUNC PartyChatControlGetProperty;
    PartyChatControlGetPropertyKeys_FUNC PartyChatControlGetPropertyKeys;
    PartyChatControlSetProperties_FUNC PartyChatControlSetProperties;
...
#define PARTY_FUNCTION_COUNT 148
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyEndpointGetProperty(endpoint, key, value);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyEndpointGetPropertyKeys(endpoint, propertyCount, keys);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyEndpointSetProperties(endpoint, propertyCount, keys, values);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyDeviceGetProperty(device, key, value);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyDeviceGetPropertyKeys(device, propertyCount, keys);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyDeviceSetProperties(device, propertyCount, keys, values);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyNetworkCreateEndpoint(network, localUser, propertyCount, keys, values, asyncIdentifier, endpoint);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyNetworkGetProperty(network, key, value);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyNetworkGetPropertyKeys(network, propertyCount, keys);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyNetworkSetProperties(network, propertyCount, keys, values);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyChatControlGetProperty(chatControl, key, value);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyChatControlGetPropertyKeys(chatControl, propertyCount, keys);
}
    ...
    )
{
    ...
    return partyFunctions->FunctionTable.PartyChatControlSetProperties(chatControl, propertyCount, keys, values);
}
