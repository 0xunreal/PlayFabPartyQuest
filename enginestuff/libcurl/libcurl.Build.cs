...
public class libcurl : ModuleRules
{
	public libcurl(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		string AndroidLibCurlPath = Target.UEThirdPartySourceDirectory + "libcurl/curl-7.75.0/";
		...
		else if (Target.IsInPlatformGroup(UnrealPlatformGroup.Android))
		{
			...
			string IncludePath = AndroidLibCurlPath + "include" + platform;
			string LibraryPath = AndroidLibCurlPath + "lib" + platform;
